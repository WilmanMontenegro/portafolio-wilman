...
## Material de apoyo (bloque Wilman)
...
- Diapos públicas: `public/curso-ia-marketing/diapos/index.html`
  ...
  - Orden: LLM → token → contexto → cobro → riesgos → prompts → proveedores → productividad → **decks (NotebookLM / Claude Design)** → ROI
...
- Diapos del bloque técnico: `public/curso-ia-marketing/diapos/` (compartibles con asistentes)
